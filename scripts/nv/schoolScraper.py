...
#--------------------define variables-------------------
FOLDER_PATH = 'school_district/'
OUTPUT_FILE = 'school_district.csv'
#-------------------------------------------------------
...
class SchoolScraper:
    def __init__(self,
                 ...
                 home_url='http://transparentnevada.com/agencies/salaries/school-districts/'
                 ):
    ...
    def GetSchoolList(self):
        ...
        if ret.status_code == 200:
            ...
            for tr in trs:
                school = {
                    'school_name': Selector(text=tr).xpath('//td[1]/a/text()').extract()[0],
    ...
    def Start(self):
        ...
        school_list = self.GetSchoolList()
        ...
        for school in school_list:
            ...
            # get csv file list
            print('getting csv file list for %s ...' % (school_name))
            csv_list = self.GetCsvList(school_url)
